...
export default function BlockOptionsDropdownList({
  ...
  const formatBulletList = () => {
    if (blockType !== "ul") {
      editor.dispatchCommand<any>(INSERT_UNORDERED_LIST_COMMAND, null);
    } else {
      editor.dispatchCommand<any>(REMOVE_LIST_COMMAND, null);
    }
    setShowBlockOptionsDropDown(false);
  };
  ...
  const formatNumberedList = () => {
    if (blockType !== "ol") {
      editor.dispatchCommand<any>(INSERT_ORDERED_LIST_COMMAND, null);
    } else {
      editor.dispatchCommand<any>(REMOVE_LIST_COMMAND, null);
    }
    setShowBlockOptionsDropDown(false);
