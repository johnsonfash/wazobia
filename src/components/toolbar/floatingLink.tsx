...
import { $getSelection, $isRangeSelection, GridSelection, LexicalEditor, NodeSelection, RangeSelection, SELECTION_CHANGE_COMMAND } from "lexical";
import { useCallback, useEffect, useRef, useState } from "react";
import getSelectedNode from "./getSelectedNode";
import positionEditorElement from "./positionEditorElement";

export const LowPriority = 1;
export default function FloatingLinkEditor({ editor }: { editor: LexicalEditor }) {
